...
export const Header = () => {
  return (
    <div className=" text-3xl lg:text-4xl  w-full  flex justify-center items-center lg:justify-around  lg:h-16 font-bold  italic hover:animate-pulse active:animate-pulse  lg:pt-24 pt-5 gap-10">
